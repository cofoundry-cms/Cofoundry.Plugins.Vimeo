...
var projectsToBuild = new string[]{
    "./src/Cofoundry.Plugins.Vimeo.Domain/Cofoundry.Plugins.Vimeo.Domain.csproj",
    "./src/Cofoundry.Plugins.Vimeo.Admin/Cofoundry.Plugins.Vimeo.Admin.csproj",
    "./src/Cofoundry.Plugins.Vimeo/Cofoundry.Plugins.Vimeo.csproj",
};
